...
if (MONTH == "annual"){
  ...
  #                            suffix_to_export )
  suffix_to_export <- paste0(YEAR_DISCARD, "_", MONTH_AS_CHARACTER)
}
...
PATH_FILES <- "C:/Users/ieoma/Desktop/sap/oab_post_dump/data/2021/2021_07_silvia"
...
trips_filter <- c("DESIXA210729S", "DESIXA210722S", "DESIXA210720S")

OAB_trips <- OAB_trips[OAB_trips$COD_MAREA %in% trips_filter, ]
OAB_hauls <- OAB_hauls[OAB_hauls$COD_MAREA %in% trips_filter,]
OAB_catches <- OAB_catches[OAB_catches$COD_MAREA %in% trips_filter,]
OAB_lengths <- OAB_lengths[OAB_lengths$COD_MAREA %in% trips_filter,]
OAB_litter <- OAB_litter[OAB_litter$COD_MAREA %in% trips_filter,]
...
PATH_ERRORS <- "C:/Users/ieoma/Desktop/sap/oab_post_dump/data/2021/2021_07_silvia/errors"
